...
gamma = 1         #[0.1-1 по статье]
T = 1               # Период времени
# sigma = 0.000270 #74.737988    2    0.000270
k = 1.5             # [1.5 - 2] 25.8526   1.5
...
if __name__ == "__main__":
    ...
    try:
        while datetime.now() < end_time:
            ...
            combine_data()
            trading_algorithm()
            time.sleep(0.005)  # Ждем 0.05 секунду перед следующим шагом
    except KeyboardInterrupt:
